...
/* harmony export */ });
/* harmony import */ var _hau_app_routes_const__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @hau/app.routes.const */ 5276);
/* harmony import */ var _hau_features_auth_auth_routes_const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @hau/features/auth/auth.routes.const */ 8536);
/* harmony import */ var _hau_features_auth_auth_guard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @hau/features/auth/auth.guard */ 8802);



const routes = [{
  path: _hau_app_routes_const__WEBPACK_IMPORTED_MODULE_0__.HAU_ROUTES.auth.path,
  loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_features_auth_auth_routes_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./features/auth/auth.routes */ 9105)).then(mod => mod.authRoutes)
}, {
  ...
  loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_features_main_main_routes_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./features/main/main.routes */ 6327)).then(mod => mod.mainRoutes)
}, {
  path: '**',
...
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./auth.service */ 6256);
/* harmony import */ var _hau_features_auth_auth_routes_const__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @hau/features/auth/auth.routes.const */ 8536);
...
class AuthService {
  ...
  checkSession() {
    return this.http.get(`${this.API_URL}/auth/me`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(() => true), (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.catchError)(error => {
      console.error("Session check failed:", error);
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.of)(false);
    }));
  }
  refreshSession() {
    return this.http.post(`${this.API_URL}/auth/refresh`, {}).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(() => true), (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.catchError)(error => {
  ...
  refreshAccessToken() {
    return this.http.post(`${this.API_URL}/auth/refresh-token`, {}).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(res => res.accessToken), (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.catchError)(error => {
  ...
  static {
    this.ɵfac = function AuthService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || AuthService)(_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_7__.HttpClient));
    };
  }
  static {
...
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 4363);
/* harmony import */ var _hau_features_auth_auth_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @hau/features/auth/auth.service */ 6256);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ 7919);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs */ 1318);
...
const authErrorInterceptor = (req, next) => {
  ...
  return next(req).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_3__.catchError)(error => {
    if (error.status === 401) {
      return authService.refreshSession().pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_4__.switchMap)(() => next(req)),
      // Reface requestul original după refresh
...
/* harmony import */ var _ngxs_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngxs/store */ 8267);
...
/* harmony import */ var _angular_platform_browser_animations_async__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/platform-browser/animations/async */ 9192);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ 3305);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/router */ 6264);
...
/* harmony import */ var _ngneat_transloco__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @ngneat/transloco */ 6075);
/* harmony import */ var _hau_app_routes__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @hau/app.routes */ 2181);
/* harmony import */ var _hau_app_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @hau/app.component */ 92);
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./environments/environment */ 5312);
/* harmony import */ var _hau_core_transloco_transloco_http_loader_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @hau/core/transloco/transloco-http-loader.service */ 3839);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @angular/common/http */ 698);
/* harmony import */ var _ngxs_store__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @ngxs/store */ 8267);
/* harmony import */ var _hau_shared_state_app_app_state__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @hau/shared/state/app/app.state */ 896);
/* harmony import */ var _ngxs_logger_plugin__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @ngxs/logger-plugin */ 9899);
/* harmony import */ var _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @auth0/angular-jwt */ 2389);
/* harmony import */ var _hau_features_auth_authErrorInterceptor__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @hau/features/auth/authErrorInterceptor */ 3288);
...
/* harmony import */ var _hau_features_auth_with_credentials_interceptor__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @hau/features/auth/with-credentials.interceptor */ 7073);
/* harmony import */ var _auto_gen_api_api_configuration__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./auto-gen/api/api-configuration */ 6171);
