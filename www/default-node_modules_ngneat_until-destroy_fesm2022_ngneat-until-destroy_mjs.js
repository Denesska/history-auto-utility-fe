"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["default-node_modules_ngneat_until-destroy_fesm2022_ngneat-until-destroy_mjs"],{
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs/operators */ 13255);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rxjs/operators */ 33900);



const NG_PIPE_DEF = _angular_core__WEBPACK_IMPORTED_MODULE_5__.NG_PIPE_DEF;
...
function unsubscribe(property) {
  if (property instanceof rxjs__WEBPACK_IMPORTED_MODULE_1__.Subscription) {
...
function setupSubjectUnsubscribedChecker(instance, destroy$) {
  ...
  runOutsideAngular(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(Promise.resolve()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.mergeMap)(() => {
    let lContext;
    try {
      ...
      lContext = (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.getLContext)(instance);
    } catch {
      lContext = null;
    }
  ...
  (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.mergeMap)(() => Promise.resolve())).subscribe(() => {
...
function runOutsideAngular(fn) {
  ...
  const Zone = _angular_core__WEBPACK_IMPORTED_MODULE_5__._global.Zone;
...
function untilDestroyed(instance, destroyMethodName) {
  return source => {
    ...
    return source.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.takeUntil)(destroy$));
  };
}
